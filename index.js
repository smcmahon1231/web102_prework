...
const fundingMessage = document.createElement("p");
fundingMessage.innerHTML = fundingMessageString;
descriptionContainer.appendChild(fundingMessage);
...
firstGameElement.innerHTML = `Top Pledge: ${firstGame.name}`;
